...
void basic_ncpizero_selection()
{
  ...
  std::vector cumulative_cuts = make_cumulative_cuts(ncpizero_cuts);
  std::vector n_minus_one_cuts = make_n_minus_one_cuts(ncpizero_cuts);

  std::vector all_cuts = ncpizero_cuts;
  ...
  fill_and_save_spectra(inputName, all_cuts, ncpizero_sig_back_categories);

  plot_selection(ncpizero_cuts, ncpizero_sig_back_categories, gPOT);
  plot_selection(cumulative_cuts, ncpizero_sig_back_categories, gPOT);
  plot_selection(n_minus_one_cuts, ncpizero_sig_back_categories, gPOT);
